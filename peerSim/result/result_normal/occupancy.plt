...
set autoscale y
set ylabel 'Cumulative Occupancy'
plot "occupancy_cuckoo.tsv" every ::2 using 1:2 with lines title "Cuckoo" lw 1 lc rgb "red"
...
plot "occupancy_owner.tsv" every ::2 using 1:2 with lines title "Owner" lc rgb "blue",\
	...
	"occupancy_cuckoo.tsv" every ::2 using 1:2 with lines title "Cuckoo" lc rgb "red",\
