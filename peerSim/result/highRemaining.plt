...
set output 'eps/highRemaining_owner.eps'
...
set output 'eps/highRemaining_path.eps'
set terminal postscript eps color
replot
...
set output 'eps/highRemaining_relate.eps'
set terminal postscript eps color
replot
...
set output 'eps/highRemaining_cuckoo.eps'
set terminal postscript eps color
replot
...
set output 'eps/highRemaining_comp.eps'
set terminal postscript eps color
replot
...
set output 'eps/highRemaining_comp_expansion.eps'
set terminal postscript eps color
replot