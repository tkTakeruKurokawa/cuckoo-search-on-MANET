...
set yrange [0.0:1.0]
set ylabel 'Data Availability'
plot "counter_cuckoo.tsv" every ::2 using 1:2 with lines title "Cuckoo" lw 1 lc rgb "red"
...
plot "counter_owner.tsv" every ::2 using 1:2 with lines title "Owner" lc rgb "blue",\
	...
	"counter_cuckoo.tsv" every ::2 using 1:2 with lines title "Cuckoo" lc rgb "red",\

set output 'eps/counter_comp.eps'
set terminal postscript eps color
replot
