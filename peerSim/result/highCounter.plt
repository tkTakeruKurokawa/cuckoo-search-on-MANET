...
set output 'eps/highCounter_owner.eps'
...
set output 'eps/highCounter_path.eps'
set terminal postscript eps color
replot
...
set output 'eps/highCounter_relate.eps'
set terminal postscript eps color
replot
...
set output 'eps/highCounter_cuckoo.eps'
set terminal postscript eps color
replot
...
set output 'eps/highCounter_comp.eps'
set terminal postscript eps color
replot
...
set output 'eps/highCounter_comp_expansion.eps'
set terminal postscript eps color
replot