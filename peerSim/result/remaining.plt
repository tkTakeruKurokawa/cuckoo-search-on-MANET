...
plot "remaining_cuckoo.tsv" every ::2 using 1:2 with lines lc rgb "red" title "Cuckoo"
...
"remaining_cuckoo.tsv" every ::2 using 1:2 with lines lw 2 lc rgb "red" title "Cuckoo"
# plot "remaining_owner.tsv" every ::2 using 1:2:3 with errorbars lc rgb "gray70" notitle,\
...
set output 'eps/remaining_comp.eps'
set terminal postscript eps color
replot
